...
export const timezones = {
  ...
  zones: {
    ...
    'Asia/Dubai': {
      ...
      comments: 'UAE, Oman, Réunion, Seychelles, Crozet, Scattered Is',
    },
    'Asia/Kabul': {
      name: 'Asia/Kabul',
      lat: 34.5167,
    ...
    'Europe/Berlin': {
      ...
      comments: 'Germany (most areas), Scandinavia',
    },
    ...
    'Pacific/Tarawa': {
      ...
      comments: 'Gilberts, Marshalls, Tuvalu, Wallis & Futuna, Wake',
    },
    'Pacific/Kanton': {
      name: 'Pacific/Kanton',
      lat: -1.2167,
    ...
    'Indian/Maldives': {
      ...
      long: 73.5,
      countries: ['MV', 'TF'],
      comments: 'Maldives, Kerguelen, St Paul I, Amsterdam I',
    },
    'America/Mexico_City': {
