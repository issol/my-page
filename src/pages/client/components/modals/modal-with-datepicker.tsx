import { Box, Button, Typography, FormControl, Autocomplete, IconButton } from '@mui/material'
...
export default function ModalWithDatePicker({
  ...
  const handleTimezoneChange = (v: any) => {
    ...
    setData({ 
      ...data, 
      paymentTimezone: { label: selectedTimezone.label, code: selectedTimezone.code }
    })
  }
              ...
              <Autocomplete
                ...
                value={
                  !data.paymentTimezone
                    ...
                    : timezoneList.find(
                      (zone) =>
                        zone.label === data.paymentTimezone?.label
                    )!
                }
