...
import LanguagePairTable from 'src/pages/[companyName]/components/language-pair-detail'
import { useGetClientPriceList } from '@src/queries/company/standard-price'
import ItemDetail from 'src/pages/[companyName]/components/item-detail'
