...
import CATInterfaceChipDuplicationModal from 'src/pages/[companyName]/components/standard-prices-modal/modal/CAT-interface-chip-duplication-modal'
import {
...
const CatInterface = ({
  ...
  useEffect(() => {
    if (!isLoading && catInterface && priceUnitList.length > 0 && priceData) {
      ...
      const phrase: PriceUnitListWithHeaders[] = priceData.catInterface!.phrase
        .length
        ? [
