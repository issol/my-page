...
import SelectReasonModal from 'src/pages/[companyName]/quotes/components/modal/select-reason-modal'
...
import SimpleMultilineAlertWithCumtomTitleModal from 'src/pages/[companyName]/components/modals/custom-modals/simple-multiline-alert-with-custom-title-modal'
...
const ProjectInfo = ({
  ...
  const onClickDelete = () => {
    if (
      !project?.linkedInvoiceReceivable &&
      project?.linkedJobs?.length === 0
    ) {
      openModal({
