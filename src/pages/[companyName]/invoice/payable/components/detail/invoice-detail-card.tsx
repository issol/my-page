...
// ** components
import InvoiceDetailInfoForm from 'src/pages/[companyName]/components/forms/invoice-detail-info-form'
        ...
        <ConfirmSaveAllChanges
          ...
          onSave={() => {
            ...
            const res = {
              ...getInvoiceData,
              payDueTimezone:
                getInvoiceData.payDueTimezone?.label &&
                getInvoiceData.payDueTimezone?.code
                  ? {
                      label: getInvoiceData.payDueTimezone.label,
                      code: getInvoiceData.payDueTimezone.code,
                    }
                  : null,
              paidDateTimezone:
                getInvoiceData.paidDateTimezone?.label &&
                getInvoiceData.paidDateTimezone?.code
                  ? {
                      label: getInvoiceData.paidDateTimezone.label,
                      code: getInvoiceData.paidDateTimezone.code,
                    }
                  : null,
            }
