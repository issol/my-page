  ...
  useEffect(() => {
    ...
    if (langItem && prices && invoiceInfo && client) {
      ...
      const items = [...langItem.orders]
        .sort((a, b) =>
          sortByOrderCorporationId(a.corporationId, b.corporationId),
        )
        .map(item =>
      ...
      const res: InvoiceProjectInfoFormType = {
        ...
        invoiceDateTimezone:
          invoiceInfo.invoicedTimezone && timezoneList.length > 0
            ? timezoneList.find(
        ...
        paymentDueDate: {
          ...
          timezone:
            invoiceInfo.payDueTimezone && timezoneList.length > 0
              ? timezoneList.find(
        ...
        invoiceConfirmDate: {
          date:
            invoiceInfo.clientConfirmedAt && invoiceInfo.clientConfirmTimezone
              ...
              : null,
          timezone:
            invoiceInfo.clientConfirmTimezone && timezoneList.length > 0
              ? timezoneList.find(
        ...
        taxInvoiceDueDate: {
          date:
            invoiceInfo.taxInvoiceDueAt && invoiceInfo.taxInvoiceDueTimezone
              ...
              : null,
          timezone:
            invoiceInfo.taxInvoiceDueTimezone && timezoneList.length > 0
              ? timezoneList.find(
        ...
        paymentDate: {
          date:
            invoiceInfo.paidAt && invoiceInfo.paidDateTimezone
              ...
              : null,
          timezone:
            invoiceInfo.paidDateTimezone && timezoneList.length > 0
              ? timezoneList.find(
        ...
        taxInvoiceIssuanceDate: {
          date:
            ...
            invoiceInfo.taxInvoiceIssuedDateTimezone
              ...
              : null,
          timezone:
            invoiceInfo.taxInvoiceIssuedDateTimezone && timezoneList.length > 0
              ? timezoneList.find(
                  zone =>
                    zone.code ===
                    invoiceInfo.taxInvoiceIssuedDateTimezone?.code,
                )!
              : defaultTimezone,
        },
        salesRecognitionDate: {
          ...
          timezone: invoiceInfo.salesCheckedDateTimezone
            ? timezoneList.find(
                zone =>
                  zone.code === invoiceInfo.salesCheckedDateTimezone?.code,
              )!
            : defaultTimezone,
        },
