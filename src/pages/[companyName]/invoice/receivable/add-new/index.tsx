  ...
  function onSubmit() {
    ...
    const res: InvoiceReceivablePatchParamsType = {
      ...
      invoicedTimezone: projectInfo.invoiceDateTimezone
        ? {
            label: projectInfo.invoiceDateTimezone.label,
            code: projectInfo.invoiceDateTimezone.code,
          }
        : null,
      ...
      payDueTimezone: projectInfo.paymentDueDate.timezone
        ? {
            label: projectInfo.paymentDueDate.timezone.label,
            code: projectInfo.paymentDueDate.timezone.code,
          }
        : null,
